...
const GALLERY_PHOTOS: GalleryItem[] = [
  ...
  },
  {
    ...
    image: '/images/gallery_hilo_aceite_lavene.jpg',
  },
  {
    id: '7',
    tag: 'Tradición Viva',
    caption: 'Todo empieza en el olivo: paciencia, respeto y cuidado diario del fruto.',
    image: '/images/gallery_nace_en_olivo.jpg',
  },
  {
    id: '8',
    tag: 'Orgullo Sanjuanino',
    caption: 'Compartiendo nuestro aceite virgen extra premiado con toda la comunidad.',
    image: '/images/event_recognition.jpg',
  },
];
